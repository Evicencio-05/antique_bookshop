...
def create_groups_and_profiles(apps, schema_editor):
    ...
    GROUPS_TO_CREATE = [
        ...
        },
        {
            ...
            "description": "Assistant Manager - Can access and modify all employee information and is allowed to modify Author, Book, Group, and Customer data.",
            "permissions": [
                "add_employee",
                "change_employee",
                "delete_employee",
    ...
    for group_data in GROUPS_TO_CREATE:
        ...
        GroupProfile.objects.update_or_create(
            group=created_group, defaults={"description": group_data["description"]}
        )
