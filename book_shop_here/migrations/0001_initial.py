    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(db_index=True, max_length=500, verbose_name="Book title"),
                ),
                (
                    "cost",
                    models.DecimalField(decimal_places=2, max_digits=11, verbose_name="Book cost"),
                ),
                (
                    "retail_price",
                    models.DecimalField(
                ...
                (
                    ...
                    models.DateField(
                        ...
                        validators=[
                            ...
                            django.core.validators.MaxValueValidator(datetime.date(2099, 12, 31)),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_number",
                    models.CharField(max_length=50, verbose_name="Employee phone number"),
                ),
                (
                    "address",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order_date",
                    models.DateField(auto_now_add=True, verbose_name="Date when order was placed"),
                ),
                ...
                (
                    "books",
                    models.ManyToManyField(related_name="orders", to="book_shop_here.book"),
                ),
                (
                    "customer_id",
                    models.ForeignKey(
