...
urlpatterns = [
    ...
    path("reports/sales/", views.SalesDashboardView.as_view(), name="sales-dashboard"),
    ...
    path("employees/<int:pk>/sales/", views.EmployeeSalesView.as_view(), name="employee-sales"),
