...
def create_super_user_fixed(request):
    """
    Creates an initial superuser after running migrations.
    ...
    try:
        ...
        try:
            ...
            <body>
                <h1 class="error">Database Migration Error</h1>
                <div class="error">
                    <strong>Error:</strong> Failed to run database migrations<br>
                    <strong>Details:</strong> {str(migration_error)}
                </div>
                <p>The database tables couldn't be created. Please check your DATABASE_URL environment variable.</p>
            </body>
            </html>
            """)
