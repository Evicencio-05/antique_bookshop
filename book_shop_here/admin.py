...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ['order_id', 'customer_id__first_name', 'customer_id__last_name', 'employee_id__first_name', 'employee_id__last_name']
    ...
    completed_order.short_description = "Complete selected orders"